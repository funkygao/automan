...
/**
 * 模仿jdk5的annotation功能实现meta programming.
 *
 * 想使用本功能的方法，无法autoload，必须手工require_once本文件！
 *
 * @package base
...
class ReflectionAnnotatedClass extends ReflectionClass
{
     ...
     *
     * @return Annotation False if non-exist
     */
     ...
     * @param string $name
     *
     * @return ReflectionAnnotatedMethod Null if non-exist
     */
     ...
     * @param string $name
     *
     * @return ReflectionAnnotatedProperty Null if non-exist
     */
